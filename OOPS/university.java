...
class University
{
	...
	public Person(String name,int sYear,long ad,String ifscCode,long account_nu,int hn,String city,String st)
	{
		this.name = name;
		this.sYear = sYear;
		acc = new College();
...
//---------------------------------inner class----------------------------------	
	class College
	{
		...
		public College(String ifsc_code, long account_nu)
		{
...
class Test
{
	...
	{	
		...
		University u = new University(name,age,ad,ifscCode,account_nu,hn,city,st);
		u.displayPerson();		
	}
}