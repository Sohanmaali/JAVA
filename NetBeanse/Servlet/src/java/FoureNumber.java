...
public class FoureNumber extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<center>");
            out.print("<form action ='FourValue1'>");
            ...
            out.print("<td>");
            out.print("<center>");
            out.print(" <input id='d' class='inp'  type='submit' name='answer' value='Fibbonaci'>");
            out.print(" <br> <input class='inp' type='submit' name='answer' value='PrimeSeries'>");
            out.print(" <br><input class='inp' type='submit' name='answer' value='power3'>");
            out.print(" <br><input class='inp' type='submit' name='answer' value='power4'>");
            out.print("<br> <input class='inp' type='submit' name='answer' value='power5'>");
            out.print(" <br><input class='inp' type='submit' name='answer' value='power6'>");
            out.print(" <br><input class='inp' type='submit' name='answer' value='power7'>");
