    ...
    <body class="bg-color">
        ...
        <section class="container mt-5" style="padding-top: 40px">
            <div class="row justify-content-md-center">
                <form class="col-md-6 col-sm-12 bg-white p-5 rounded shadow" action="EmployeeRegistration" onsubmit="return validate()">
                    <div class="col-12 text-center">
                        <h3 class="text-primary"><strong>E Register Now</strong></h3>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 text-center text-secondary mt-3">
                        Have already an account? <a href="EmployeeLogin.jsp">Login Now</a>
                    </div>
                </form>
            </div>
        </section>
