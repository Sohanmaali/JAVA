			...
			if (ch < 0 || ch > 100) {
				...
				if (math < 0 || math > 100) {
					...
					if (hindi < 0 || hindi > 100) {
						...
						} else if ((py < 33 && ch < 33 && math < 33 && hindi < 33)
								|| (py < 33 && ch < 33 && math < 33 & eng < 33)
								|| (py < 33 && math < 33 && hindi < 33 && eng < 33)
								|| (py < 33 && ch < 33 && hindi < 33 && eng < 33)
								|| (ch < 33 && math < 33 && hindi < 33 && eng < 33)) {
						...
						} else if ((py < 33 && ch < 33 && math < 33) || (py < 33 && ch < 33 && hindi < 33)
								|| (py < 33 && math < 33 && hindi < 33)
								|| (ch < 33 && math < 33 && hindi < 33) || (py < 33 && ch < 33 && eng < 33)
								|| (math < 33 && hindi < 33 && eng < 33)
								|| (ch < 33 && hindi < 33 && eng < 33) || (py < 33 && hindi < 33 && eng < 33)
								|| (eng < 33 && math < 33 && ch < 33)
						...
						} else if ((py < 33 && ch < 33) || (py < 33 && math < 33) || (py < 33 && hindi < 33)
								|| (py < 33 && eng < 33) ||
								(ch < 33 && math < 33) || (ch < 33 && hindi < 33) || (ch < 33 && eng < 33)
								|| (math < 33 && eng < 33)
