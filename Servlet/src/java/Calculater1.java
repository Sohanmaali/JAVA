...
//            out.print("<lable style='width:97%; height:30px;' >Enter First Number: </lable>   ");
            ...
            out.print("   <input style='width:97%; height:30px;' type = 'text' placeholder='Enter First Number' required name='n1'>");
            out.print("</td>");
            out.print("</tr>");
            out.print("<tr>");
            out.print("<td>");
//            out.print("<lable style='width:97%; height:30px;' >Enter Second Number: </lable>   ");
            ...
            out.print("   <input style='width:97%; height:30px;' type = 'text' placeholder='Enter Second number' required name='n2'>");
            out.print("</td>");
            out.print("</tr>");
