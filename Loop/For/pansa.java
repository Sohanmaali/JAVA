    ...
    while (sum <= 100) {
      ...
      sum =
        (
          sum == 99
            ? sum = 26
            : (sum == 96 ? sum = 86 : (sum == 90 ? sum = 68 : (sum += 0)))
        );
      sum =
        (
          sum == 50
            ? sum = 34
            : (sum == 35 ? sum = 5 : (sum == 39 ? sum = 3 : (sum += 0)))
        );
      sum =
        (
          sum == 28
            ? sum = 77
            : (sum == 2 ? sum = 23 : (sum == 7 ? sum = 29 : (sum += 0)))
        );
      sum =
        (
          sum == 30
            ? sum = 32
            : (sum == 22 ? sum = 41 : (sum == 44 ? sum = 58 : (sum += 0)))
        );
      sum =
        (
          sum == 54
            ? sum = 69
            : (sum == 70 ? sum = 90 : (sum == 80 ? sum = 83 : (sum += 0)))
        );
        ...
        case '1':
          ...
          sum1 =
            (
              sum1 == 99
                ? 26
                : (sum1 == 96 ? 86 : (sum1 == 90 ? 68 : (sum1 += 0)))
            );
          sum1 =
            (
              sum1 == 50
                ? 34
                : (sum1 == 35 ? 5 : (sum1 == 39 ? 3 : (sum1 += 0)))
            );
          ...
          sum1 =
            (
              sum1 == 28
                ? 77
                : (sum1 == 2 ? 23 : (sum1 == 7 ? 29 : (sum1 += 0)))
            );
          sum1 =
            (
              sum1 == 30
                ? 32
                : (sum1 == 22 ? 41 : (sum1 == 44 ? 58 : (sum1 += 0)))
            );
          sum1 =
            (
              sum1 == 54
                ? 69
                : (sum1 == 70 ? 90 : (sum1 == 80 ? 83 : (sum1 += 0)))
            );
          sum1 = (sum1 == 87 ? 93 : (sum1 += 0));

          sum1 =
            (
              (sum1 == 95 && (a == 1 || a == 2 || a == 3 || a == 4 || a == 5))
                ? sum1 += a
                : (sum1 += 0)
            );
          sum1 =
          ...
          do {
            ...
            turm = sc.next().charAt(0);
            if (turm != '2') System.out.println("\tNot your turm");
          } while (turm != '2');
        case '2':
