...
interface DataClass {
	...
	public abstract double operation(double a, double b, double c double d);
	
}

class Operation {
	
	DataClass add =(double a,double b)-> a+b;
	
	DataClass sub =(double a,double b) -> a-b;
	...
	DataClass pow1 = (double a,double b) -> Math.pow(a,b);
}
