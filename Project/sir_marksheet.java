...
class Operation      // BL Class
{
	...
	{
		DataClass sk[][] = new DataClass[2][5];
		...
		System.out.println("\t\t   --------------------------------------------------------------------");
		System.out.println( "\t\t   |\tBCA102       Math           100            33            " + ref[i].sk[1][2].getMark());
		System.out.println("\t\t   --------------------------------------------------------------------");
		System.out.println( "\t\t   |\tBCA103       Hindi          100            33            " + ref[i].sk[1][3].getMark() );
		System.out.println("\t\t   --------------------------------------------------------------------");
		System.out.println( "\t\t   |\tBCA104       English        100            33            " + ref[i].sk[1][4].getMark());
		System.out.println("\t\t   --------------------------------------------------------------------");
		System.out.println( "\t\t   |\n\t\t   |" );
		ob.division(ref,i);
		System.out.println("\t\t   |\n\t\t   |\n\t\t   |\n\t\t   |");
...
class Mark           // Clinte Class
{
	...
	public void takeInput(int n,DataClass student[],Operation ob2)
	{
		...
		for(int i =0;i<n;i++)
		{
			...
			System.out.println("\t\t-------------------------------"); */
			student[i] = new DataClass(name, fname,  mname,  sem,  branch,  corse,  year,  roll,mark); 
			//student[i].setTotel();
			//student[i].setPer();
