...
class DataClass { // POJO Class
  ...
  public void setTotel() {
    this.total =
      getphysics() + getchemistry() + getmath() + gethindi() + getenglish();
  }
...
class Operation { // BL Class
      ...
      switch (choice) {
        case 1:
          ...
          if (flag) {
            ...
            System.out.println(
              "\t\t\t\t      Enter Roll Number Is Not exist : "
            );
            System.out.println(
              "\t\t  --------------------------------------------------------------------" +
              resetColor
      ...
      switch (choice) {
        case 1:
          for (int i = 0; i < n; i++) {
            if (
              student[i].getPer() >= 60 &&
              student[i].getPer() <= 100 &&
              student[i].getphysics() > 33 &&
              student[i].getchemistry() > 33 &&
              student[i].getmath() > 33 &&
              student[i].gethindi() > 33 &&
              student[i].getenglish() > 33
            ) {
              ob2.printMarksheet(student, i);
              flag = false;
            }
          ...
          if (flag) {
            ...
            System.out.println(
              "\t\t\t\t      First Division student Not aveleval"
            );
            System.out.println(
              "\t\t  --------------------------------------------------------------------" +
              resetColor
        ...
        case 2:
          ...
          if (flag) {
            ...
            System.out.println(
              "\t\t\t\t      Second Division student Not aveleval"
            );
            System.out.println(
              "\t\t  --------------------------------------------------------------------" +
              resetColor
        ...
        case 3:
          ...
          if (flag) {
            ...
            System.out.println(
              "\t\t\t\t      Third Division student Not aveleval"
            );
            System.out.println(
              color +
              "\t\t  --------------------------------------------------------------------" +
  ...
  public void printMarksheet(DataClass ref[], int i) {
    ...
    System.out.println(
      "\t\t   |\tSubCode      SubName       MaxMarks      MinMarks      ObtMark"
    );
    System.out.println(
      "\t\t   --------------------------------------------------------------------"
    );
    System.out.println(
      "\t\t   |\tBCA100       Physics        100            33            " +
      ref[i].getphysics()
    );
    System.out.println(
      "\t\t   --------------------------------------------------------------------"
  ...
  public void division(DataClass ref[], int i) {
    if (
      ...
      if (
        ...
        System.out.println(
          "   \t\t   |\tFail in phycics,getchemistry(),mathes,Hindi"
        );
      } else if (
        ref[i].getphysics() < 33 &&
        ref[i].getchemistry() < 33 &&
        ...
        System.out.println(
          "   \t\t   |\tFail in phycics,chemistry,mathes,enlish"
        );
      } else if (
        ref[i].getphysics() < 33 &&
        ref[i].getmath() < 33 &&
        ...
        System.out.println(
          "   \t\t   |\tFail in phycics,chemistry,hindi,enlish"
        );
      } else if (
        ref[i].getchemistry() < 33 &&
        ref[i].getmath() < 33 &&
        ...
        System.out.println(
          "   \t\t   |\tFail in chemistry,mathes,hindi,enlish"
        );
      }
    } else if (
      (
  ...
  public int takeMark() {
    ...
    do {
      ...
      if (mark < 0 || mark > 100) {
        ...
        System.out.println(
          "\t\t      Invalide marks of Please enter Agen mark!"
        );
        System.out.println(
          "\t\t  --------------------------------------------------------------------" +
          resetColor
          ...
          switch (choice) {
            ...
            case 2:
              if (i != 0) {
                ...
                System.out.println(
                  "\t\t      Student data not aveleval please  insert sum student data"
                );
                System.out.println(
                  "\t\t  --------------------------------------------------------------------" +
                  resetColor
