...
class Demo {
    ...
    public static void printUserData(int rollNumber) throws IOException {
        ...
        String name = properties.getProperty("Roll");
        ...
        int hindi = Integer.parseInt(properties.getProperty("Hindi"));
        int english = Integer.parseInt(properties.getProperty("English"));
        int science = Integer.parseInt(properties.getProperty("Science"));
        int math = Integer.parseInt(properties.getProperty("Math"));
        int chem = Integer.parseInt(properties.getProperty("Chem"));
        int roll = Integer.parseInt(properties.getProperty("Roll"));
